...
# # typealias ArrayLike{T} Union{Vector{T}, Ptr{T}}
...
# #     ccall((:fftwf_execute_dft_c2r, "libfftw3f"), Void, (FFTW.PlanPtr, Ptr{Complex{Float32}}, Ptr{Float32}), plan, src, dest)
# # end

# function execute_dft_c2r!(dest::ArrayLike{Float64}, src::ArrayLike{Complex{Float64}}, plan::FFTW.PlanPtr)
#     ccall((:fftw_execute_dft_c2r, "libfftw3"), Void, (FFTW.PlanPtr, Ptr{Complex{Float64}}, Ptr{Float64}), plan, src, dest)
# end
